...
public class JeffStats : MonoBehaviour
{
    ...
    // types of attack, lightAttack0,1,2 are from combo and heavyAttack is heavyAttack
    public enum AnimationTags
    {
        none, lightAttack0, lightAttack1, lightAttack2, heavyAttack, consumableUsed
    }
    ...
    IEnumerator Flash()
    {
        ...
        if (!pc.boosting) // this condition is to dont go white too soon if player is boosting/usingRage. If there was not this condition, character would be both white and rage boosting.
        {
